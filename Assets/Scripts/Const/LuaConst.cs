...
public static class LuaConst {
    ...
    public static string toluaDir = luaDir + "toLua/";        //tolua lua文件目录
    public static string toluaCSDir = Application.dataPath + "/3rdLibrary/ToLua/ToLua/"; //tolua c#
